...
export default function Home() {
  ...
  }, [phase, lastTurn, lastRound, matchResult, play, onMatchEnd, triggerArenaAction, fireEffect]);
...
function LobbyScreen({
  ...
  const difficulties: { level: Difficulty; label: string; desc: string }[] = [
    ...
    { level: "grandmaster", label: "Grandmaster", desc: "Solved the game. Near-unbeatable." },
  ];
